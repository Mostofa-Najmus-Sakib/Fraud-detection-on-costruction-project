function [Cont_typo_fraud_counter] = Cont_Typo_fraud_counter(pay_affect_dep,Result_Cont)
...
%     disp(major_cell(y))
    dep_data_z_38 = Result_Cont(strcmp(Result_Cont.Cell,cell2mat(major_cell(y))),:);
    ...
    Cont_major_typo_fraud  = [height(data_amount_major), height(data_amount_major_typo), height(data_amount_major_fraud)];
end
...
%     disp(major_cell(y))
    dep_data_z_38_moderate = Result_Cont(strcmp(Result_Cont.Cell,cell2mat(moderate_cell(y))),:);
    ...
    Cont_moderate_typo_fraud  = [height(data_amount_moderate), height(data_amount_moderate_typo), height(data_amount_moderate_fraud)];
end
...
%     disp(major_cell(y))
    dep_data_z_38_minor = Result_Cont(strcmp(Result_Cont.Cell,cell2mat(minor_cell(y))),:);
    ...
    Cont_minor_typo_fraud  = [height(data_amount_minor), height(data_amount_minor_typo), height(data_amount_minor_fraud)];
end

Cont_typo_fraud_counter = [Cont_major_typo_fraud,Cont_moderate_typo_fraud,Cont_minor_typo_fraud ];
