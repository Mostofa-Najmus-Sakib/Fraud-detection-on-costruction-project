function [Result_Dep,Count_Dep_major_minor_moderate] = Dep_Typo_Fraud_Lot(final_result_dep,pay_affect_dep )
...
%%
        ...
        if row ==3
            ...
            Count_Dep_major_minor_moderate = [ counter_dep_major,counter_major_typo,counter_major_fraud, counter_dep_moderate,counter_moderate_typo,counter_moderate_fraud, counter_dep_minor,counter_minor_typo,counter_minor_fraud];
...
Result_Dep = sortrows(final_matrix,'Var_effect_type');
