%% dept 
[~,~,raw2] = xlsread('Dep_value_all_corrected_1st') ;
[~,~,raw2] = xlsread('Dep_value_all_corrected_last') ;

%% dept
[~,~,raw2] = xlsread('Dep_value_all_corrected_19965_last') ;

%% cont

[~,~,raw2] = xlsread('last_typo_first_fraud_dep_19965') ;
[~,~,raw2] = xlsread('last_typo_first_fraud_dep_19965') ;

% [t1, t2, t3] = xlsread('ITD0777_7')
%%
% u32 = data(2).('$Z$129');
filenametest = 'ITD0777_19965_D10001.xlsx';   %%% change value on each run 
...
for i = 1:length(key)
    ...
    %filenametest = 'ITD0777_13947_D6.xlsx';
...
xlswrite(filenametest, 2.677, '0777', 'BB29')
xlswrite(filenametest, 2.562, '0777', 'BB33')
xlswrite(filenametest, 1.0320, '0777', 'BB41')


xlswrite(filenametest, 3, '0777', 'BG56')
xlswrite(filenametest, 5, '0777', 'BJ56')

xlswrite(filenametest, 15, '0777', 'BG58')
%xlswrite(filenametest, 2.677, '0777', 'BJ58')

xlswrite(filenametest, 73, '0777', 'BG60')
xlswrite(filenametest, 76, '0777', 'BJ60')

xlswrite(filenametest, 5.5, '0777', 'BG62')
xlswrite(filenametest, 8.5, '0777', 'BJ62')
...
% xlswrite(filenametest, 1519.8, '0777', 'N131') 
% xlswrite(filenametest, 2389.5, '0777', 'Z37') 
% xlswrite(filenametest, 1418.4, '0777', 'U38') 
